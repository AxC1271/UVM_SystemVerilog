...
Now with all of that out of the way, we can finally start designing the AXI-Lite Master. We'll be focusing on a 32-bit system, although these same concepts can be applied on 64-bit as well.
